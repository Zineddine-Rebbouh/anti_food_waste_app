...
class CharityOrgProfileScreen extends StatefulWidget {
  const CharityOrgProfileScreen({super.key});

  @override
  State<CharityOrgProfileScreen> createState() =>
      _CharityOrgProfileScreenState();
}

class _CharityOrgProfileScreenState extends State<CharityOrgProfileScreen> {
  @override
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    return Scaffold(
        ...
        child: Column(
          children: [
            ...
            FadeInUp(
                ...
                duration: const Duration(milliseconds: 600),
                child: _buildAboutCard(l10n)),
            const SizedBox(height: 16),
            FadeInUp(
                delay: const Duration(milliseconds: 200),
                duration: const Duration(milliseconds: 600),
                child: _buildActivityOverview(context, l10n)),
            const SizedBox(height: 16),
            FadeInUp(
                delay: const Duration(milliseconds: 300),
                duration: const Duration(milliseconds: 600),
                child: _buildSettingsShortcuts(context, l10n)),
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [CharityMainScreen.primaryGreen, Color(0xFF0D2119)],
        ),
        borderRadius: BorderRadius.only(
            bottomLeft: Radius.circular(56), bottomRight: Radius.circular(56)),
      ),
      child: Stack(
        children: [
          Positioned(
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text(l10n.organisation_profile.toUpperCase(),
                          style: TextStyle(
                  ...
                  Hero(
                    ...
                    child: Container(
                      ...
                      child: const Center(
                          child: Icon(Icons.apartment_rounded,
                              size: 56, color: CharityMainScreen.primaryGreen)),
                    ),
                  ),
                  const SizedBox(height: 24),
                  Text(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                            '${l10n.verified_charity} · ${l10n.location_algiers}',
                            style: const TextStyle(
                                color: Colors.white,
                                fontSize: 10,
                                fontWeight: FontWeight.w900,
                  ...
                  Row(
                    ...
                    children: [
                      _ProfileStat(
                          value: '128', label: l10n.pickups_tab.toUpperCase()),
                      Container(
                          width: 1.5,
                          height: 24,
                          color: Colors.white.withOpacity(0.1)),
                      _ProfileStat(
                          value: '4.8k',
                          label: l10n.meals_provided.toUpperCase()),
                      Container(
                          width: 1.5,
                          height: 24,
                          color: Colors.white.withOpacity(0.1)),
                      _ProfileStat(
                          value: '12', label: l10n.wilayas_stat.toUpperCase()),
                    ],
                  ),
                ],
              ),
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: CharityMainScreen.primaryGreen.withOpacity(0.04),
                blurRadius: 20,
        ...
        child: Column(
          ...
          children: [
            Text(l10n.about_us.toUpperCase(),
                style: TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.w900,
                    color: Colors.grey.shade400,
            ...
            Text(l10n.charity_about_us_msg,
                style: TextStyle(
                    fontSize: 14,
            ...
            _ContactRow(
                ...
                text: l10n.charity_phone_placeholder),
            const SizedBox(height: 14),
            _ContactRow(
                icon: Icons.alternate_email_rounded,
                text: l10n.charity_email_placeholder),
            const SizedBox(height: 14),
            _ContactRow(
                icon: Icons.location_on_rounded,
                text: l10n.charity_address_placeholder),
          ],
        ),
      ),
    );
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(l10n.activity_overview.toUpperCase(),
                style: TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.w900,
                    color: Colors.grey.shade400,
              ...
              children: [
                Expanded(
                    child: _MiniStatTile(
                        ...
                        title: '128',
                        subtitle: l10n.completed_pickups)),
              ...
              children: [
                ...
                Expanded(
                    child: _MiniStatTile(
                        ...
                        title: '4.9',
                        subtitle: l10n.avg_merchant_rating)),
              ],
            ),
            const SizedBox(height: 24),
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      CharityMainScreen.primaryGreen.withOpacity(0.05),
        ...
        child: Column(
          children: [
            ...
            _SettingsRow(
              ...
              label: l10n.language,
              trailing: Text(_getLanguageName(context),
                  style: TextStyle(
                      fontSize: 13,
    ...
    return Padding(
      ...
      child: TextButton(
        ...
        style: TextButton.styleFrom(
            ...
            padding: const EdgeInsets.symmetric(vertical: 16)),
        child: Text(l10n.sign_out.toUpperCase(),
            style: const TextStyle(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? const Color(0xFF2D8659).withOpacity(0.05)
              : Colors.grey.shade50,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
              color: isSelected ? const Color(0xFF2D8659) : Colors.transparent,
              width: 1.5),
        ),
        child: Row(
          children: [
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Container(
          ...
          child: Icon(icon, size: 20, color: const Color(0xFF2D8659))),
      title: Text(label,
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w700,
